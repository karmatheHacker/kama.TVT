  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-slate-900 rounded-xl border border-slate-800 w-full max-w-md p-6 relative">
        ...
        <div className="mb-6">
          <h2 className="text-2xl font-bold text-white mb-2">{isLogin ? "Welcome Back" : "Join KamaTV"}</h2>
          <p className="text-slate-400">
            {isLogin ? "Sign in to continue watching" : "Create your account to get started with KamaTV"}
          </p>
        </div>
